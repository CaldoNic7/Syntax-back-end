"""
Django settings for syntax_back_end project.
...
if os.getenv('ENV') == 'development':
  ...
  CORS_ORIGIN_WHITELIST = ['http://localhost:4741']
else:
...
ROOT_URLCONF = 'syntax_back_end.urls'
...
WSGI_APPLICATION = 'syntax_back_end.wsgi.application'
